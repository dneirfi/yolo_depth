...
extern void adam_gpu(int n, float *x, float *m, float *v, float B1, float B2, float rate, float eps, int t)
{
...
extern void adam_update_gpu(float *w, float *d, float *m, float *v, float B1, float B2, float eps, float decay, float rate, int n, int batch, int t)
{
    scal_gpu(n, B1, m, 1);
    scal_gpu(n, B2, v, 1);
...
extern void normalize_delta_gpu(float *x, float *mean, float *variance, float *mean_delta, float *variance_delta, int batch, int filters, int spatial, float *delta)
{
...
extern void mean_delta_gpu(float *delta, float *variance, int batch, int filters, int spatial, float *mean_delta)
{
...
extern void fast_mean_delta_gpu(float *delta, float *variance, int batch, int filters, int spatial, float *mean_delta)
{
...
extern void fast_variance_delta_gpu(float *x, float *delta, float *mean, float *variance, int batch, int filters, int spatial, float *variance_delta)
{
...
extern void normalize_gpu(float *x, float *mean, float *variance, int batch, int filters, int spatial)
{
    size_t N = batch*filters*spatial;
...
extern void l2normalize_gpu(float *x, float *dx, int batch, int filters, int spatial)
{
...
extern void fast_mean_gpu(float *x, int batch, int filters, int spatial, float *mean)
{
...
extern void fast_variance_gpu(float *x, float *mean, int batch, int filters, int spatial, float *variance)
{
...
extern void mean_gpu(float *x, int batch, int filters, int spatial, float *mean)
{
...
extern void variance_gpu(float *x, float *mean, int batch, int filters, int spatial, float *variance)
{
...
extern void axpy_gpu(int N, float ALPHA, float * X, int INCX, float * Y, int INCY)
{
    axpy_gpu_offset(N, ALPHA, X, 0, INCX, Y, 0, INCY);
}

//extern "C" void pow_gpu(int N, float ALPHA, float * X, int INCX, float * Y, int INCY)
extern void pow_gpu(int N, float ALPHA, float * X, int INCX, float * Y, int INCY)
{
...
extern void axpy_gpu_offset(int N, float ALPHA, float * X, int OFFX, int INCX, float * Y, int OFFY, int INCY)
{
...
extern void copy_gpu(int N, float * X, int INCX, float * Y, int INCY)
{
    copy_gpu_offset(N, X, 0, INCX, Y, 0, INCY);
}

//extern "C" void mul_gpu(int N, float * X, int INCX, float * Y, int INCY)
extern void mul_gpu(int N, float * X, int INCX, float * Y, int INCY)
{
...
extern void copy_gpu_offset(int N, float * X, int OFFX, int INCX, float * Y, int OFFY, int INCY)
{
...
extern void flatten_gpu(float *x, int spatial, int layers, int batch, int forward, float *out)
{
...
extern void reorg_gpu(float *x, int w, int h, int c, int batch, int stride, int forward, float *out)
{
...
extern void mask_gpu(int N, float * X, float mask_num, float * mask, float val)
{
...
extern void scale_mask_gpu(int N, float * X, float mask_num, float * mask, float scale)
{
...
extern void const_gpu(int N, float ALPHA, float * X, int INCX)
{
...
extern void constrain_gpu(int N, float ALPHA, float * X, int INCX)
{
...
extern void add_gpu(int N, float ALPHA, float * X, int INCX)
{
...
extern void scal_gpu(int N, float ALPHA, float * X, int INCX)
{
...
extern void supp_gpu(int N, float ALPHA, float * X, int INCX)
{
...
extern void fill_gpu(int N, float ALPHA, float * X, int INCX)
{
...
extern void shortcut_gpu(int batch, int w1, int h1, int c1, float *add, int w2, int h2, int c2, float s1, float s2, float *out)
{
...
extern void smooth_l1_gpu(int n, float *pred, float *truth, float *delta, float *error)
{
...
extern void softmax_x_ent_gpu(int n, float *pred, float *truth, float *delta, float *error)
{
...
extern void logistic_x_ent_gpu(int n, float *pred, float *truth, float *delta, float *error)
{
...
extern void l2_gpu(int n, float *pred, float *truth, float *delta, float *error)
{
...
extern void l1_gpu(int n, float *pred, float *truth, float *delta, float *error)
{
...
extern void wgan_gpu(int n, float *pred, float *truth, float *delta, float *error)
{
...
extern void deinter_gpu(int NX, float *X, int NY, float *Y, int B, float *OUT)
{
...
extern void inter_gpu(int NX, float *X, int NY, float *Y, int B, float *OUT)
{
...
extern void weighted_sum_gpu(float *a, float *b, float *s, int num, float *c)
{
...
extern void weighted_delta_gpu(float *a, float *b, float *s, float *da, float *db, float *ds, int num, float *dc)
{
...
extern void mult_add_into_gpu(int num, float *a, float *b, float *c)
{
...
extern void softmax_tree(float *input, int spatial, int batch, int stride, float temp, float *output, tree hier)
{
...
extern void softmax_gpu(float *input, int n, int batch, int batch_offset, int groups, int group_offset, int stride, float temp, float *output)
{
...
extern void upsample_gpu(float *in, int w, int h, int c, int batch, int stride, int forward, float scale, float *out)
{
