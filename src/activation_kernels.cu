...
extern void binary_gradient_array_gpu(float *x, float *dx, int n, int size, BINARY_ACTIVATION a, float *y) 
{
...
extern void binary_activate_array_gpu(float *x, int n, int size, BINARY_ACTIVATION a, float *y) 
{
...
extern void activate_array_gpu(float *x, int n, ACTIVATION a) 
{
...
extern void gradient_array_gpu(float *x, int n, ACTIVATION a, float *delta) 
{
