...
void run_coco(int argc, char **argv)
{
    ...
    else if(0==strcmp(argv[2], "demo")) demo(cfg, weights, thresh, cam_index, filename, coco_classes, 80, /*frame_skip,*/ prefix, avg, .5, 0,0,0,0, 0 /*full camera image*/, 0 /* no depth estimation*/, 0 /*just one depth*/, 0 /*dummy for path aggretation*/, -1 /*dummy for percent_closest*/, -1 /*dummy for alpha of stereoRectify*/, false /*dummy for is_ocam*/, false /*dummy for gray_4_stereo*/, false /*dummy for is_disp_2_milli*/, true /*dummy for show_all_detection*/, 1.0 /*dummy for ratio_shrink*/, NULL /*no class of interest*/, NULL /*dummy for fn_poly*/, NULL /*no cam calibration intrinsice*/, NULL /*no cam calibration extrinsic*/, false);
}
